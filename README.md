...
## Study Flow
### 질문의 생활화 - 모르는건 죄가 아니다. 가만히 있는건 죄다. 
### Pre-Study
1. 숙제 해결하기(개념공부 + 문제풀이)
* 이슈에 Week별 숙제 있습니다. 해결 할 때 까지의 과정을 commit 및 pr(숙제검사)!</br>그 과정에 대한 설명을 README.md 파일에 적기. 업로드 하는 규칙은 하단 참고... 
2. 짧은 발표 준비
* 매 스터디마다 랜덤으로 팀별 발표자 1명 선정</br>이번 숙제에 대한 내용을 간단하게 정리해서 팀 구성원에게 브리핑.
